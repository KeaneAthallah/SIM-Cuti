        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="#"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Submit
                            Cuti</a>
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button type="button"
                    ...
                    <svg class="block h-6 w-6" :class="{ 'hidden': isOpen, 'block': !isOpen }" fill="none"
